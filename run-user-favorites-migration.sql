-- Apply the user_favorites migration to create missing tables
-- This fixes the "relation 'user_favorites' does not exist" error
...
GROUP BY s.id, s.idea_title, s.idea_description, s.uploaded_by, s.uploaded_date, s.is_approved
